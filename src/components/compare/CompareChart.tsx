...
function CustomTooltip({
  ...
  return (
    <div className="rounded-lg border border-zinc-700 bg-zinc-900/95 p-3 shadow-xl text-xs backdrop-blur-sm min-w-[180px]">
  ...
  if (isLoading) {
    return (
      <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-5">
        ...
        <Skeleton className="h-72 w-full bg-zinc-800/50 rounded-lg" />
      </div>
    )
  }
