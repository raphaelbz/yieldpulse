...
function CustomTooltip({
  ...
  return (
    <div className="rounded-lg border border-white/[0.08] bg-[#1c1c1e]/95 p-3 shadow-xl backdrop-blur-sm text-xs">
...
function ChartSkeleton({ label }: { label: string }) {
  return (
    <div className="rounded-xl border border-white/[0.07] bg-[#1c1c1e] p-5">
      ...
      <Skeleton className="h-64 w-full bg-[#2c2c2e]/50 rounded-lg" />
    </div>
  )
}
