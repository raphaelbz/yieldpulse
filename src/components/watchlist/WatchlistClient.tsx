...
function WatchlistEmpty() {
  return (
    <div className="rounded-xl border border-white/[0.07] bg-[#1c1c1e] flex flex-col items-center justify-center py-24 text-center px-4">
  ...
  return (
    <div className="grid grid-cols-3 gap-3">
      {[
        ...
        <div key={label} className="rounded-lg border border-white/[0.07] bg-[#1c1c1e] px-4 py-3">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          {watchedPools.length > 0 && (
            <Button
              ...
              className="h-8 border-white/[0.08] bg-[#1c1c1e] text-zinc-300 hover:text-white text-xs"
            >
